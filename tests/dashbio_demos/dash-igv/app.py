...
#
# # Datasets
# with open(os.path.join(DATAPATH, 'GCF_009858895.2_ASM985889v3_genomic.fna.fai'), encoding='utf-8') as data_file:
#     GCF_009858895_2_ASM985889v3_genomic_fna_fai = json.loads(data_file.read())
#
# with open(os.path.join(DATAPATH, 'GCF_009858895.2_ASM985889v3_genomic.fna'), encoding='utf-8') as data_file:
#     GCF_009858895_2_ASM985889v3_genomic_fna = json.loads(data_file.read())
#
# with open(os.path.join(DATAPATH, 'GCF_009858895.2_ASM985889v3_genomic.gff.gz'), encoding='utf-8') as data_file:
#     GCF_009858895_2_ASM985889v3_genomic_gff_gz = json.loads(data_file.read())

with open('data/GCF_009858895.2_ASM985889v3_genomic.fna', 'r') as f:
    data1 = f.read()

with open('data/GCF_009858895.2_ASM985889v3_genomic.fna.fai', 'r') as f:
    data2 = f.read()

with open('data/GCF_009858895.2_ASM985889v3_genomic.gff', 'r') as f:
    data3 = f.read()
...
app.layout = html.Div([
    dcc.Store(id='store', data=[data1, data2, data3]),
    ...
    dash_bio.Igv(
                ...
                reference={
                    ...
                    "fastaURL": "data/GCF_009858895.2_ASM985889v3_genomic.fna",
                    "indexURL": "data/GCF_009858895.2_ASM985889v3_genomic.fna.fai",
                    "order": 1000000,
                    "tracks": [
                        {
                            "name": "Annotations",
                            "url": "data/GCF_009858895.2_ASM985889v3_genomic.gff.gz",
...
@app.callback(
    Output('myigv', 'reference'),
    Input('store', 'data')
)
def update_data(input_dict):
    return {
        "id": "ASM985889v3",
        "name": "Sars-CoV-2 (ASM985889v3)",
        "fastaURL": input_dict[0],
        "indexURL": input_dict[1],
        "order": 1000000,
        "tracks": [
            {
                "name": "Annotations",
