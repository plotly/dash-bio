...
default_sliders = [
    html.Div(
        ...
        children=[
            html.Div("Atom radius", className="app-controls-name"),
            dcc.Slider(
    ...
    html.Div(
        className="app-controls-block",
        children=[
            html.Div("Relative atom radius", className="app-controls-name"),
            dcc.Slider(
    ...
    html.Div(
        className="app-controls-block",
        children=[
            html.Div("Ambient occlusion", className="app-controls-name"),
            dcc.Slider(
                id="speck-ao",
                className="control-slider",
                max=1,
    ...
    html.Div(
        className="app-controls-block",
        children=[
            html.Div("Brightness", className="app-controls-name"),
            dcc.Slider(
                id="speck-brightness",
                className="control-slider",
                max=1,
    ...
    dcc.Checklist(
        ...
        options=[{"label": "Show bonds", "value": "True"}],
        value=[],
    ),
    html.Div(
        className="app-controls-block",
...
def header_colors():
    return {"bg_color": "#5673FA", "font_color": "white"}
                            ...
                            dcc.Tab(
                                ...
                                children=html.Div(
                                    ...
                                    children=[
                                        ...
                                        html.P(
                                            "Speck is a WebGL-based molecule renderer. By "
                                            "using ambient occlusion, the resolution of "
                                            "the rendering does not suffer as you zoom in."
                                        ),
                                        html.P(
                                            "You can toggle between molecules using the menu under "
                                            'the "Data" tab, and control parameters related to '
                                                ...
                                                dcc.Dropdown(
                                                    ...
                                                    options=[
                                                        ...
                                                        },
                                                        {
                                                            "label": "Caffeine",
                                                            "value": os.path.join(
                                                                DATAPATH, "caffeine.xyz"
                                                            ),
                                                        },
                                                        {
                                                            "label": "Methane",
                                                            "value": os.path.join(
                                                                DATAPATH, "methane.xyz"
                                                            ),
                                                        },
                                                        {
                                                            "label": "Testosterone",
                                                        ...
                                                        },
                                                        {
                                                            ...
                                                            "value": os.path.join(
                                                                DATAPATH, "au_thiol.xyz"
                                                            ),
                                                        },
                                                        {
                                                            "label": "Benzene",
                                                            "value": os.path.join(
                                                                DATAPATH, "benzene.xyz"
                                                            ),
                                                        },
                                                        {
                                                            "label": "Protein (4E0O)",
...
def callbacks(_app):
    ...
    def preset_callback(atomstyle_ts, render_ts, render, atomstyle):
        preset = "default"
    ...
    @_app.callback(Output("speck", "showLegend"), Input("speck-enable-legend", "value"))
