...
from utils import circos_parser as cp

layout = cp.txt_to_layout(
    file_one_name="./upload_data/GRCh37.txt",
    file_two_name="./upload_data/GRCh38.txt",
    append_one="-7",
    append_two="-8",
    relPath=True,
    create_local=False,
...
track_one = cp.txt_to_track(
    file_name="./upload_data/GRCh37.txt",
    append_block_id="-7",
    relPath=True,
    create_local=False,
)
track_two = cp.txt_to_track(
    file_name="./upload_data/GRCh38.txt",
    append_block_id="-8",
    relPath=True,
    create_local=False,
)
