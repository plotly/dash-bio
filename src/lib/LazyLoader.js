...
export default {
    ...
    molecule2dViewer: () =>
        import(/* webpackChunkName: "moleculeviewer2" */ './fragments/Molecule2dViewer.react'),
    molecule3dViewer: () =>
        import(/* webpackChunkName: "moleculeviewer3" */ './fragments/Molecule3dViewer'),
    needlePlot: () =>
        import(/* webpackChunkName: "needle" */ './fragments/NeedlePlot.react'),
    oncoPrint: () =>
        import(/* webpackChunkName: "onco" */ './fragments/OncoPrint.react'),
    sequenceViewer: () =>
        import(/* webpackChunkName: "sequence" */ './fragments/SequenceViewer.react'),
    speck: () =>
