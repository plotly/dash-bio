...
from tests.dash.utils.needle_plot_parser import extract_mutations, extract_domains
...
app.layout = app_page_layout(app_main_layout, app_title="Dash Bio : Needleplot")
