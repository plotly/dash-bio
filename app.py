...
app.layout = html.Div([
    ...
    dcc.Tabs(
        ...
        children=[
            ...
            dcc.Tab(label='Homology', children=[
                html.Div(
                    [
                        html.Div(
                            [
                        ...
                        html.Div(
                            [
                                dash_bio.DashIdeogram(
                                    id="ideo-homology",
                                    dataDir="/app/static/data/bands/native/",
...
def annot_tracks(value, Shape):
    if value == "heatmap":
        ...
        value = [
            {"id": 'pathogenicTrack', "displayName": 'Pathogenic',
             "color": '#F00', "shape": Shape},
            {"id": 'uncertainSignificanceTrack', "displayName": 'Uncertain significance',
             "color": '#CCC', "shape": Shape},
            {"id": 'benignTrack',  "displayName": 'Benign',
             "color": '#8D4', "shape": Shape}
        ]
        return value
    return None
...
def ideo_homology(startOne, stopOne, startTwo, stopTwo, startOneA, stopOneA, startTwoA, stopTwoA):
    return {
        "chrOne": {
            "organism": "9606",
