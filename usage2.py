...
with open ('./data/input_data2.js') as f1:
    model=json.load(f1)

#with open('./src/lib/example/js/cartoon_style.js') as s1:
with open ('./data/input_style_cartoon2.js') as s1:
    style_cartoon=json.load(s1)

with open ('./data/input_style_sphere2.js') as s2:
    style_sphere=json.load(s2)

with open ('./data/input_style_stick2.js') as s3:
